...
The [3D SDF functions article](https://iquilezles.org/articles/distfunctions) is pretty popular, so I decided to write a similar one for 2D primitives, since most of the 3D primitives are grown as extrusions or revolutions of these 2D shapes. So getting these right is important. In particular, the functions bellow use the minimum number of square roots and divisions possible, and also produce better/faster results than constructing them from other primitives (when possible).  
  
Note that all the primitives listed here come with a link to a realtime online demo in Shadertoy. In fact, this public playlist contains all the Shadertoy examples: [https://www.shadertoy.com/playlist/MXdSRf](https://www.shadertoy.com/playlist/MXdSRf), so don't miss that out.  
...
**Circle - exact**   ([https://www.shadertoy.com/view/3ltSW2](https://www.shadertoy.com/view/3ltSW2))  
...
![](https://iquilezles.org/articles/distfunctions2d/gfx34.png)

**Rounded Box - exact**   ([https://www.shadertoy.com/view/4llXD7](https://www.shadertoy.com/view/4llXD7) and [https://www.youtube.com/watch?v=s5NGeUV2EyU](https://www.youtube.com/watch?v=s5NGeUV2EyU))  
...
![](https://iquilezles.org/articles/distfunctions2d/gfx51.png)

**Chamfer Box - exact**   ([https://www.shadertoy.com/view/3fc3zs](https://www.shadertoy.com/view/3fc3zs))  
...
![](https://iquilezles.org/articles/distfunctions2d/gfx02.png)

**Box - exact**   ([https://www.youtube.com/watch?v=62-pRVZuS5c](https://www.youtube.com/watch?v=62-pRVZuS5c))  
...
![](https://iquilezles.org/articles/distfunctions2d/gfx36.png)

**Oriented Box - exact**   ([https://www.shadertoy.com/view/stcfzn](https://www.shadertoy.com/view/stcfzn))  
...
![](https://iquilezles.org/articles/distfunctions2d/gfx03.png)

**Segment - exact**   ([https://www.shadertoy.com/view/3tdSDj](https://www.shadertoy.com/view/3tdSDj) and [https://www.youtube.com/watch?v=PMltMdi1Wzg](https://www.youtube.com/watch?v=PMltMdi1Wzg))  
...
![](https://iquilezles.org/articles/distfunctions2d/gfx09.png)

**Rhombus - exact**   ([https://www.shadertoy.com/view/XdXcRB](https://www.shadertoy.com/view/XdXcRB))  
...
![](https://iquilezles.org/articles/distfunctions2d/gfx11.png)

**Isosceles Trapezoid - exact**   ([https://www.shadertoy.com/view/MlycD3](https://www.shadertoy.com/view/MlycD3))  
...
![](https://iquilezles.org/articles/distfunctions2d/gfx37.png)

**Parallelogram - exact**   ([https://www.shadertoy.com/view/7dlGRf](https://www.shadertoy.com/view/7dlGRf))  
...
![](https://iquilezles.org/articles/distfunctions2d/gfx04.png)

**Equilateral Triangle - exact**   ([https://www.shadertoy.com/view/Xl2yDW](https://www.shadertoy.com/view/Xl2yDW))  
...
![](https://iquilezles.org/articles/distfunctions2d/gfx10.png)

**Isosceles Triangle - exact**   ([https://www.shadertoy.com/view/MldcD7](https://www.shadertoy.com/view/MldcD7))  
...
![](https://iquilezles.org/articles/distfunctions2d/gfx07.png)

**Triangle - exact**   ([https://www.shadertoy.com/view/XsXSz4](https://www.shadertoy.com/view/XsXSz4))  
...
![](https://iquilezles.org/articles/distfunctions2d/gfx12.png)

**Uneven Capsule - exact**   ([https://www.shadertoy.com/view/4lcBWn](https://www.shadertoy.com/view/4lcBWn))  
...
![](https://iquilezles.org/articles/distfunctions2d/gfx05.png)

**Regular Pentagon - exact**   ([https://www.shadertoy.com/view/llVyWW](https://www.shadertoy.com/view/llVyWW))  
...
![](https://iquilezles.org/articles/distfunctions2d/gfx18.png)
...
![](https://iquilezles.org/articles/distfunctions2d/gfx15.png)

**Regular Octogon - exact**   ([https://www.shadertoy.com/view/llGfDG](https://www.shadertoy.com/view/llGfDG))  
...
![](https://iquilezles.org/articles/distfunctions2d/gfx17.png)

**Hexagram - exact**   ([https://www.shadertoy.com/view/tt23RR](https://www.shadertoy.com/view/tt23RR))  
...
![](https://iquilezles.org/articles/distfunctions2d/gfx19.png)

**Pentagram - exact**   ([https://www.shadertoy.com/view/t3X3z4](https://www.shadertoy.com/view/t3X3z4))  
  
```hlsl
float sdPentagram(in vec2 p, in float r ) { const float k1x = 0.809016994; // cos(π/ 5) = ¼(√5+1) const float k2x = 0.309016994; // sin(π/10) = ¼(√5-1) const float k1y = 0.587785252; // sin(π/ 5) = ¼√(10-2√5) const float k2y = 0.951056516; // cos(π/10) = ¼√(10+2√5) const float k1z = 0.726542528; // tan(π/ 5) = √(5-2√5) const vec2 v1 = vec2( k1x,-k1y); const vec2 v2 = vec2(-k1x,-k1y); const vec2 v3 = vec2( k2x,-k2y); p.x = abs(p.x); p -= 2.0*max(dot(v1,p),0.0)*v1; p -= 2.0*max(dot(v2,p),0.0)*v2; p.x = abs(p.x); p.y -= r; return length(p-v3*clamp(dot(p,v3),0.0,k1z*r)) * sign(p.y*v3.x-p.x*v3.y); }
```


![](https://iquilezles.org/articles/distfunctions2d/gfx28.png)

**Regular Star - exact**   ([https://www.shadertoy.com/view/3tSGDy](https://www.shadertoy.com/view/3tSGDy))  
...
![](https://iquilezles.org/articles/distfunctions2d/gfx24.png)

**Pie - exact**   ([https://www.shadertoy.com/view/3l23RK](https://www.shadertoy.com/view/3l23RK))  
...
![](https://iquilezles.org/articles/distfunctions2d/gfx42.png)

**Cut Disk - exact**   ([https://www.shadertoy.com/view/ftVXRc](https://www.shadertoy.com/view/ftVXRc))  
...
![](https://iquilezles.org/articles/distfunctions2d/gfx25.png)

**Arc - exact**   ([https://www.shadertoy.com/view/wl23RK](https://www.shadertoy.com/view/wl23RK))  
...
![](https://iquilezles.org/articles/distfunctions2d/gfx50.png)

**Ring - exact**   ([https://www.shadertoy.com/view/DsccDH](https://www.shadertoy.com/view/DsccDH))  
...
![](https://iquilezles.org/articles/distfunctions2d/gfx26.png)

**Horseshoe - exact**   ([https://www.shadertoy.com/view/WlSGW1](https://www.shadertoy.com/view/WlSGW1))  
...
![](https://iquilezles.org/articles/distfunctions2d/gfx13.png)

**Vesica - exact**   ([https://www.shadertoy.com/view/XtVfRW](https://www.shadertoy.com/view/XtVfRW))  
...
![](https://iquilezles.org/articles/distfunctions2d/gfx48.png)

**Oriented Vesica - exact**   ([https://www.shadertoy.com/view/cs2yzG](https://www.shadertoy.com/view/cs2yzG))  
...
![](https://iquilezles.org/articles/distfunctions2d/gfx39.png)

**Moon - exact**   ([https://www.shadertoy.com/view/WtdBRS](https://www.shadertoy.com/view/WtdBRS))  
...
![](https://iquilezles.org/articles/distfunctions2d/gfx41.png)

**Circle Cross - exact**   ([https://www.shadertoy.com/view/NslXDM](https://www.shadertoy.com/view/NslXDM))  
...
![](https://iquilezles.org/articles/distfunctions2d/gfx29.png)

**Simple Egg - exact**   ([https://www.shadertoy.com/view/XtVfRW](https://www.shadertoy.com/view/Wdjfz3))  
...
![](https://iquilezles.org/articles/distfunctions2d/gfx38.png)

**Heart - exact**   ([https://www.shadertoy.com/view/3tyBzV](https://www.shadertoy.com/view/3tyBzV))  
...
![](https://iquilezles.org/articles/distfunctions2d/gfx14.png)

**Cross - exact exterior, bound interior**   ([https://www.shadertoy.com/view/XtGfzw](https://www.shadertoy.com/view/XtGfzw))  
...
![](https://iquilezles.org/articles/distfunctions2d/gfx27.png)

**Rounded X - exact**   ([https://www.shadertoy.com/view/3dKSDc](https://www.shadertoy.com/view/3dKSDc))  
...
![](https://iquilezles.org/articles/distfunctions2d/gfx16.png)

**Polygon - exact**   ([https://www.shadertoy.com/view/wdBXRW](https://www.shadertoy.com/view/wdBXRW))  
...
![](https://iquilezles.org/articles/distfunctions2d/gfx06.png)

**Ellipse - exact**   ([https://www.shadertoy.com/view/4sS3zz](https://www.shadertoy.com/view/4sS3zz))  
...
![](https://iquilezles.org/articles/distfunctions2d/gfx01.png)

**Parabola - exact**   ([https://www.shadertoy.com/view/ws3GD7](https://www.shadertoy.com/view/ws3GD7))  
...
![](https://iquilezles.org/articles/distfunctions2d/gfx35.png)

**Parabola Segment - exact**   ([https://www.shadertoy.com/view/3lSczz](https://www.shadertoy.com/view/3lSczz))  
...
![](https://iquilezles.org/articles/distfunctions2d/gfx08.png)

**Quadratic Bezier - exact**   ([https://www.shadertoy.com/view/MlKcDD](https://www.shadertoy.com/view/MlKcDD))  
...
![](https://iquilezles.org/articles/distfunctions2d/gfx40.png)

**Bobbly Cross - exact**   ([https://www.shadertoy.com/view/NssXWM](https://www.shadertoy.com/view/NssXWM))  
...
![](https://iquilezles.org/articles/distfunctions2d/gfx43.png)

**Tunnel - exact**   ([https://www.shadertoy.com/view/flSSDy](https://www.shadertoy.com/view/flSSDy))  
...
![](https://iquilezles.org/articles/distfunctions2d/gfx44.png)

**Stairs - exact**   ([https://www.shadertoy.com/view/7tKSWt](https://www.shadertoy.com/view/7tKSWt))  
...
![](https://iquilezles.org/articles/distfunctions2d/gfx46.png)

**Quadratic Circle - exact**   ([https://www.shadertoy.com/view/Nd3cW8](https://www.shadertoy.com/view/Nd3cW8))  
...
![](https://iquilezles.org/articles/distfunctions2d/gfx45.png)

**Hyperbola - exact**   ([https://www.shadertoy.com/view/DtjXDG](https://www.shadertoy.com/view/DtjXDG))  
...
![](https://iquilezles.org/articles/distfunctions2d/gfx47.png)

**Cool S - exact**   ([https://www.shadertoy.com/view/clVXWc](https://www.shadertoy.com/view/clVXWc))  
...
![](https://iquilezles.org/articles/distfunctions2d/gfx49.png)

**Circle Wave - exact**   ([https://www.shadertoy.com/view/stGyzt](https://www.shadertoy.com/view/stGyzt))  
...
![](https://iquilezles.org/articles/distfunctions2d/gfx20.png) ![](https://iquilezles.org/articles/distfunctions2d/gfx21.png) ![](https://iquilezles.org/articles/distfunctions2d/gfx22.png) ![](https://iquilezles.org/articles/distfunctions2d/gfx23.png)  
...
![](https://iquilezles.org/articles/distfunctions2d/gfx30.png) ![](https://iquilezles.org/articles/distfunctions2d/gfx31.png) ![](https://iquilezles.org/articles/distfunctions2d/gfx32.png) ![](https://iquilezles.org/articles/distfunctions2d/gfx33.png)  
...
All of these work just as well as in 3D case, so I won't repeat the examples already exist in [this article](https://iquilezles.org/articles/distfunctions).